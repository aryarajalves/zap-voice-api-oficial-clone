...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # 3. Aguarde 2 segundos para o conteúdo e abas laterais renderizarem perfeitamente.
        print("Aguardando 2 segundos para renderização do modal...")
        await page.wait_for_timeout(2000)
        
        # 4. Salve uma screenshot focando no modal de configurações para comprovar o layout de duas colunas
        screenshot_path = r"C:\Users\aryar\.gemini\antigravity\brain\e2932a69-fc4b-4f16-8ccc-e5edbd95d2a4\settings_sidebar_layout.png"
