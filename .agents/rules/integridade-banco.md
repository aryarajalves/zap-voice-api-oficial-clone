...
2. **Atualização do Log:** Você deve registrar a alteração no arquivo `docs/DATABASE_SCHEMA_LOG.md`, incluindo a data, a tabela afetada, as novas colunas e o nome do script de migração.
