...
1. **Última Versão Criada:** `3.6.0`
2. **Próxima Versão:** `3.6.1`
...
3. **Comandos de Build:**
   - Backend: `docker build -t aryarajalves/zap-voice-funil-api-oficial-zap:backend-3.6.0 -f docker/Dockerfile.api .`
   - Worker: `docker build -t aryarajalves/zap-voice-funil-api-oficial-zap:worker-3.6.0 -f docker/Dockerfile.worker .`
4. **Push:** 
   - `docker push aryarajalves/zap-voice-funil-api-oficial-zap:backend-3.6.0`
   - `docker push aryarajalves/zap-voice-funil-api-oficial-zap:worker-3.6.0`
