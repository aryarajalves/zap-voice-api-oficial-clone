...
1. **Última Versão Criada:** `1.8.2`
2. **Próxima Versão:** `1.8.3`
...
3. **Comandos de Build:**
   - Backend: `docker build -t aryalvesfernandes/zapvoice:backend-1.8.2 -f docker/Dockerfile.api .`
   - Worker: `docker build -t aryalvesfernandes/zapvoice:worker-1.8.2 -f docker/Dockerfile.worker .`
4. **Push:** 
   - `docker push aryalvesfernandes/zapvoice:backend-1.8.2`
   - `docker push aryalvesfernandes/zapvoice:worker-1.8.2`
