...
export const useTriggerHistory = (refreshKey, initialTriggerType = 'bulk') => {
    ...
    const handleViewContacts = (trigger, initialFilter = 'all') => {
        const filterLabels = { total: 'Total na Lista', sent: 'Enviados', queue: 'Fila (Meta)', delivered: 'Recebidas', read: 'Lidos', failed: 'Falhas', interaction: 'Interações', blocked: 'Bloqueados', skipped: 'Pulados (24h)', free: 'Gratuitas', template: 'Templates', private_note: 'Notas Privadas', remaining: 'Restantes' };
