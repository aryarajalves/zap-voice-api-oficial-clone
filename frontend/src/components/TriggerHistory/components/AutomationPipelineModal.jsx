...
import { calculateNodeOrderMap, filterContactsByNodeStatus } from './automationPipelineUtils';
...
const AutomationPipelineModal = ({ trigger: initialTrigger, onClose, onStop, onDelete, hideTabs = false }) => {
    ...
    const handleNodeStatClick = (nodeId, clickedStatus) => {
        const nodeOrderMap = calculateNodeOrderMap(trigger);
        const contactsList = filterContactsByNodeStatus(trigger, nodeId, clickedStatus, nodeOrderMap);
