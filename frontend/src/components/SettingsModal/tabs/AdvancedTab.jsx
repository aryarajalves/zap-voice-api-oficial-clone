...
import { FiShare2, FiEyeOff, FiEye, FiChevronUp, FiChevronDown, FiAlertCircle, FiCopy, FiRefreshCw, FiPlus, FiTrash2 } from 'react-icons/fi';
                                    ...
                                    <div className="flex items-center justify-between gap-2">
                                        ...
                                        {tokensList.length > 1 && (
                                            <button
                                                ...
                                                className="text-xs text-red-500 hover:text-red-600 p-1 rounded hover:bg-red-500/10 transition-colors"
