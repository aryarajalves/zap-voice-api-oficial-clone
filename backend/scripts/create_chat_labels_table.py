...
# Ajustar path do Python para encontrar o root do backend
...
try:
    # Como ChatLabel foi adicionado em models/__init__.py, create_all vai criar a tabela chat_labels
    Base.metadata.create_all(bind=engine)
    print("[SUCCESS] Tabela chat_labels criada ou ja existente com sucesso.")
except Exception as e:
    print(f"[ERROR] Erro ao criar a tabela chat_labels: {e}")
