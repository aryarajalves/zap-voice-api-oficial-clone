...
# Ajustar path para a raiz do backend
...
try:
    ...
    print("[SUCCESS] Tabela uploaded_medias criada ou ja existente com sucesso.")
except Exception as e:
    print(f"[ERROR] Erro ao criar a tabela uploaded_medias: {e}")
