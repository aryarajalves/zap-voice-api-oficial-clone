        ...
        if res and not res.get("error"):
            ...
            try:
                ...
                if conv and conv.get("conversation_id"):
                    ...
                    # Postar a cópia do áudio no Chatwoot
                    await chatwoot.send_attachment(conversation_id, file_url, "audio")
                    logger.info(f"✅ [SYNC_CHATWOOT] Cópia do áudio postada no Chatwoot (Conversa {conversation_id})")
