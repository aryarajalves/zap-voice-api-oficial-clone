...
@router.get("/invitations", response_model=List[InvitationOut], summary="Listar Convites de Usuário")
...
@router.post("/invitations", response_model=InvitationOut, summary="Criar Convite de Usuário")
...
@router.get("/invitations/{token}", summary="Verificar Convite de Usuário (Público)")
